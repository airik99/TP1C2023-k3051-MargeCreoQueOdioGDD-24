...
/* Creo que si bien lo dice el enunciado, no los usamos
...
CREATE TABLE MargeCreoQueOdioGDD.BI_Reclamo (
	...
	--ID_PEDIDO INT NOT NULL, -- FK /*Necesitamos el local al cual se le hizo el reclamo por un pedido, ¿ponemos el ID_LOCAL directamente mejor?*/
	ID_OPERADOR INT NOT NULL, -- FK
	ID_ESTADO INT NOT NULL, -- FK
	TIEMPO_ANIO_APERTURA INT NOT NULL,
	TIEMPO_MES_APERTURA INT NOT NULL,
	DIA_APERTURA NVARCHAR(50) NOT NULL,
	RANGO_HORARIO_INICIO_APERTURA INT NOT NULL,
	RANGO_HORARIO_FIN_APERTURA INT NOT NULL,
	TIEMPO_ANIO_CIERRE INT NOT NULL,
	TIEMPO_MES_CIERRE INT NOT NULL,
	DIA_CIERRE NVARCHAR(50) NOT NULL,
	RANGO_HORARIO_INICIO_CIERRE INT NOT NULL,
	RANGO_HORARIO_FIN_CIERRE INT NOT NULL,
...
CREATE TABLE MargeCreoQueOdioGDD.BI_Pedido (
	...
	ID_ESTADO INT NOT NULL, -- FK
	ID_USUARIO INT NOT NULL, -- FK
	TIEMPO_ANIO_PEDIDO INT NOT NULL,
	TIEMPO_MES_PEDIDO INT NOT NULL,
	DIA_PEDIDO NVARCHAR(50) NOT NULL,
	RANGO_HORARIO_INICIO_PEDIDO INT NOT NULL,
	RANGO_HORARIO_FIN_PEDIDO INT NOT NULL,
	TIEMPO_ANIO_ENTREGA INT NOT NULL,
	TIEMPO_MES_ENTREGA INT NOT NULL,
	DIA_ENTREGA NVARCHAR(50) NOT NULL,
	RANGO_HORARIO_INICIO_ENTREGA INT NOT NULL,
	RANGO_HORARIO_FIN_ENTREGA INT NOT NULL,
